...
sqlite3 "$DB_FILE" 'CREATE TABLE feeds       ( userid VARCHAR(39), feedid VARCHAR(39), feedbase64 VARCHAR(1000), lastFetch BIGINT, lastModify BIGINT,  PRIMARY KEY (userid, feedid));'
