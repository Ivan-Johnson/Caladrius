...
public class GraphCursorAdapter extends CursorAdapter
{
	...
	public void bindView(View view, Context context, Cursor cursor)
	{
		...
		List<String> timeRangeList = Arrays.asList(context.getResources()
		                                                  .getStringArray(R.array.array_time_range_options));

		List<String> typeList = Arrays.asList(context.getResources()
		                                             .getStringArray(R.array.array_graph_type_options));


		final List<String> statsList = Arrays.asList(context.getResources()
		                                                    .getStringArray(R.array.array_graph_stats_options));


		List<String> colorList = Arrays.asList(context.getResources()
		                                              .getStringArray(R.array.array_graph_color_options));
		...
		try {
			...
			if (mPosition == 0) {
				...
				fgv.setOnClickListener(view1 ->
				{
					...
					intent.putExtra("graph_1_color",
						GraphEntry.GetColour(Integer.valueOf(graphColor)));
					intent.putExtra("graph_2_color",
						GraphEntry.GetColour(Integer.valueOf(graph2Color)));
