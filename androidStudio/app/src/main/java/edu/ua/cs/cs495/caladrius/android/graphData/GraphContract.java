...
public final class GraphContract
{
	...
	/**
	 * The "Content authority" is a name for the entire content provider, similar to the relationship between a
	 * domain name and its website.  A convenient string to use for the content authority is the package name for
	 ...
	 * content://edu.ua.cs.cs495.caladrius.android/graphs/ is a valid path for looking at graph data.
	 * content://edu.ua.cs.cs495.caladrius.android/staff/ will fail, as the ContentProvider hasn't been given any
	 * information on what to do with "staff".
	 */
