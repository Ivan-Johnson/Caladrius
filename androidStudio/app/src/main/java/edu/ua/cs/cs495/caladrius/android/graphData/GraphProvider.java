...
/**
 * This class is for insert, edit, delete function for graph setting table, and make sure all the input was valid.
 *
 * @author Hansheng Li
 */
public class GraphProvider extends ContentProvider
{
	...
	/**
	 * Perform the query for the given URI. Use the given projection, selection, selection arguments, and sort
	 * order.
	 */
	@Override
	...
	/**
	 * Insert a graph into the database with the given content values. Return the new content URI for that specific
	 * row in the database.
	 */
	...
	/**
	 * Update GRAPHS in the database with the given content values. Apply the changes to the rows specified in the
	 * selection and selection arguments (which could be 0 or 1 or more GRAPHS). Return the number of rows that were
